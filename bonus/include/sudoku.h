...
** Last update Sat Feb 27 12:43:53 2016 Alexandre Blanchard
*/
...
int	check_good_line(int);
void	print_the_line(int **, int);
int	show_line(int **, int);
void	resolve_sudo_line(char *, int, int);
int	get_line(int);
int	check_good_column(int);
void	print_the_column(int **, int);
int	show_column(int **, int);
void	resolve_sudo_column(char *, int, int);
int	get_column(int);
void	show_X_options();
int	without_arg();
